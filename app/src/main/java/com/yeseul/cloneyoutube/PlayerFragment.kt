...
import com.yeseul.cloneyoutube.databinding.FragmentPlayerBinding
...
class PlayerFragment: Fragment(R.layout.fragment_player) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        iniRecyclerView(fragmentPlayerBinding)
    ...
    private fun iniRecyclerView(fragmentPlayerBinding: FragmentPlayerBinding) {
    ...
    fun play(url: String, title: String) {
        context?.let{
            val dataSouFactory = DefaultDataSourceFactory(it)
            val mediaSource = ProgressiveMediaSource.Factory(dataSouFactory)
